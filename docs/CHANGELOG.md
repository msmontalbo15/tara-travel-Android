...
> Last updated: **2026-09-15 13:51 PHT**
...
- **IMP-127** (Core & Modules / Intensify User Role Scope & Least-Privilege Limitations): Enforced granular permission matrix across all feature screens via `MemberRolePermissions` extension on `MemberModel`. Gated Trip Settings edit, group expense logging and approvals, group packing items and AI templates, poll creation, and announcement broadcasts based on user roles.
