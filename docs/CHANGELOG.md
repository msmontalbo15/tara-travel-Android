...
> Last updated: **2026-09-15 04:17 PHT**
...
- **IMP-124** (Explore / Supabase Integration & Contextual Travel Recommendations): Connected Explore screen to real Supabase `public.destinations`, added category pills, personalized distance and smart contextual recommendations based on user home base and trip history, and prefilled Plan Trip navigation into `CreateTripFlow`.
...
- **IMP-121** (Home & Trips Provider / Completed Trips Filter): Excluded completed trips from the Home screen visible list and `activeTripProvider` fallback.
- **IMP-119** (Trip Detail / Command Cluster (Plans 20, 11, 16)): Announcements Hub, Departure Advisory Engine & Countdown, Tara Copilot AI Assistant.
